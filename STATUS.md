...
remaining:
  ...
  - local state (2026-09-23): the mod and its tests are committed on main; origin/main = 166f297 (pushed 2026-09-22), local main is ahead by four commits including the 0.1.0 PublishedFileId commit, not pushed; untracked and left alone on purpose: Tests/Audit-2026-09-13/ (decompilation evidence), Art/preview-background.png, Art/preview-render.png, Assets/, and six Mod/Textures/**/*.dds generated by the Workshop upload (to decide: ignore or track)
---
