...
remaining:
  ...
  - tested criterion, Pickle green in both languages: NOT YET, final passes requested 2026-09-25 (English f817, French f7c1, 22 scenarios each, tree 99be666, with -Extra '-pickle-scenario-timeout=300 -pickle-max-film-seconds=20'). Read exitReason first, then 22 played of 22 written. Green so far, by scenario and not a pass: accordion craft (b94c, 161 s, passed), accordion listening (68d4, passed, the provider holds a live sound), the 13 scenarios of features 01 to 15 in both languages (english-full3, french-full2, partial runs)
  ...
  - to read: the @review captures of both language passes (02-review-captures, 05-text-screens, 20-craft-and-film); the earlier English images (2026-09-21/22) show the pipes drawn about two cells wide, overlapping when one cell apart, unlike the provider's small ocarina: a visual reserve, nothing changed
  - unverified: the tickerType Normal correction; the loaded def reports Normal (Pickle 2026-09-21); whether a live sound follows is what 30-play-and-listen asserts (headless) and M1 checks by ear
